...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
           ...
           ['status_id', 'default', 'value' => ValueHelpers::getStatusId('Ativo')],
    ...
    {
        return static::findOne(['id' => $id, 'status_id' => ValueHelpers::getStatusId('Ativo')]);
    }
    ...
    {
        return static::findOne(['username' => $username, 'status_id' => ValueHelpers::getStatusId('Ativo')]);
    }
    ...
    public static function findByPasswordResetToken($token)
    {
        ...
        return static::findOne([
            ...
            'status_id' => ValueHelpers::getStatusId('Ativo'),
        ]);
    }
